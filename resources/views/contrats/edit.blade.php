                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h1 class="mb-2 fw-bold">
                                <i class="bi bi-file-earmark-text me-3"></i>Modifier Contrat
                            </h1>
                            <p class="mb-0 opacity-75">Mise à jour des informations du contrat</p>
                        </div>
                        <div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="societe_id" class="form-select form-select-lg @error('societe_id') is-invalid @enderror" required>
                            @foreach($societes as $societe)
                                <option value="{{ $societe->id }}" {{ old('societe_id', $contrat->societe_id) == $societe->id ? 'selected' : '' }}>
                                    {{ $societe->nom }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="row mb-4">
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="date" name="date_debut" class="form-control form-control-lg @error('date_debut') is-invalid @enderror"
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="date" name="date_fin" class="form-control form-control-lg @error('date_fin') is-invalid @enderror"
                                   value="{{ old('date_fin', $contrat->date_fin) }}" required>
                        </div>
                        @error('date_fin')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
